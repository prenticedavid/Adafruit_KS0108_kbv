...
#warning   @@@@@@@@@@@@@@@@@@@@@@@@@ <ST7920_to_SSD1306.h> @@@@@@@@@@@@@@@@@@@@@@@@@@

#ifndef ST7920_to_SSD1306_H_
#define ST7920_to_SSD1306_H_
...
class ST7920_to_SSD1306 : public Adafruit_SSD1306
{
    public:
        ST7920_to_SSD1306(int CS) : Adafruit_SSD1306(128, 64, &Wire) { }
        void init(void) {
        ...
        void drawLineH(uint8_t x0, uint8_t x1, uint8_t y, uint8_t col) {
            Adafruit_SSD1306::fillRect(x0, y, x1 - x0 + 1, 1, col);
        }
        void drawLineV(uint8_t x,  uint8_t y0, uint8_t y1, uint8_t col) {
            Adafruit_SSD1306::fillRect(x, y0, 1, y1 - y0 + 1, col);
        }
        ...
        void setFont(const uint8_t* f) {
            //Adafruit_SSD1306::setFont(&FreeSans9pt7b);
            Adafruit_SSD1306::setFont(NULL);
        }
#if IMPL_KBV > 2
        ...
        int strWidth(char *txt) {
            int16_t pos, x1, y1;
            uint16_t len, w, h;
            bool is_gfx = (Adafruit_SSD1306::gfxFont != NULL);
...
const byte ST7920_to_SSD1306::ditherTab[4 * 17] PROGMEM = {
